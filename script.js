...
document.addEventListener('DOMContentLoaded', () => {
	...
	const cdnURL = '//news-widget.jellar-web.ru';
	...
	const buildWidget = (data, createNewsList) => {
		...
		(function createStylesheetLink () {
			...
			link.setAttribute('href', `${cdnURL}/css/style.css`);
		...
		const widget = `
			<div class="widget">
				<div class="widget__header">
					<img src="${cdnURL}/images/news.svg" alt="газета" class="widget__header-icon">
			...
			<div class="widget__open">
				<img src="${cdnURL}/images/message.svg" alt="чат" class="widget__open-icon">
